...
class EditarEstadoPedido extends Component {
  ...
  cambiarEstadoPedido = (e) => {
    ...
    if (localStorage.getItem("status") === "online") {
      ...
      let arrayCambioEstado = JSON.parse(
      ...
      localStorage.setItem(
        "pedidoCambioEstado",
        JSON.stringify(arrayCambioEstado)
      );

      Swal.fire({
        title: "Atencion!",
        text:
          "La solicitud fue guardada en la solicitudes encoladas se enviara una vez se restablezca la conexion",
        type: "warning",
            ...
            <div>
              <form onSubmit={this.cambiarEstadoPedido} className="col-5">
                <div className="form-group">
                  ...
                  <div className="form-group">{this.mostrarDireccion()}</div>
                </div>
                <div className="form-group">
                  ...
                  {localStorage.getItem("status") === "online" ? (
                    <select ref={this.estadoRef} className="form-control">
                      <option disabled={true}>
                        Actual: {this.props.location.state.State}
                      </option>

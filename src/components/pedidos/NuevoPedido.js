...
class NuevoPedido extends Component {
  ...
  mostrarDatosDeCliente = () => {
    ...
    return (
      <div className="form-group">
        ...
        >
          <label center="true" align="center">
        ...
        <div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              value={this.state.telefonoClient}
              disabled
              type="number"
              min="1"
              step="1"
  ...
  mostrarDireDeCliente = () => {
    ...
    return (
      <div className="form-group">
        ...
        >
          <label center="true" align="center">
            Coloque el domicilio del cliente
          </label>
        </div>
        <div>
          <div className="form-group">
            ...
            <input
              ...
              type="text"
              className="form-control"
              placeholder="Ingrese calle, altura y ciudad"
              required
            />
          </div>
          <div className="form-group">
  ...
  generarPedido = (e) => {
    ...
    if (
      this.state.direElegida.length === 0 &&
    ...
    if (comboFiltered.length === 0 && productFiltered.length === 0) {
      ...
      if (
        localStorage.getItem("status") == "offline" &&
        this.state.cargaDeCliente === true &&
        this.state.direDeCliente === true
      ) {
        const datos_cliente = {
        ...
        if (localStorage.getItem("status") == "offline") {
          ...
          localStorage.setItem(
            "enviarPedido",
            JSON.stringify(deserializarPedidoAEnviar)
          );
    ...
    if (localStorage.getItem("status") == "online") {
      ...
      if (
        ...
        if (cliente_encontrado[0]["Adress"].length === 0) {
          ...
          cliente_encontrado[0]["Adress"].map(
            (direccion) => (
    ...
    if (this.state.direElegida.length === 0) {
      ...
      return (
        <div>
          <input
            disabled
            value={this.state.direElegida.direccion.direccion}
            type="text"
            className="form-control"
            required
          />

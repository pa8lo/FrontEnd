    ...
    return (
      ...
      >
        <Breadcrumb.Item
          ...
          style={{ color: "white" }}
        >
          <span style={{ marginTop: "60px" }}>Home</span>
        </Breadcrumb.Item>
        {this.ToHome()}
        ...
        {directories.map((dir, index) => {
          ...
          if (
            ...
            return (
              <React.Fragment>
                <Breadcrumb.Item
                  key={dir + "546848165"}
                  style={{ color: "white" }}
                  onClick={() => window.location.replace("/rrhh")}
                >
                  RRHH
                </Breadcrumb.Item>
                <Breadcrumb.Item
            ...
            b === "direccion-restaurant" ||
            dir === "direccion-restaurant"
          ) {
            if (this.state.redirectSection === true) {
            ...
            let first_word =
              double_word[0].charAt(0).toUpperCase() +
              double_word[0].substring(1);
            // let second_word = (double_word[1].charAt(0).toUpperCase() + double_word[1].substring(1))

            let def_word = first_word.split("-");

            let first_word_final =
              def_word[0].charAt(0).toUpperCase() + def_word[0].substring(1);
            let second_word_final =
              def_word[1].charAt(0).toUpperCase() + def_word[1].substring(1);
            ...
            let first_word =
              ...
              double_word[0].substring(1);
            let second_word =
              double_word[1].charAt(0).toUpperCase() +
              double_word[1].substring(1);

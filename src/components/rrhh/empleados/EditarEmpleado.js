    ...
    this.state.roles.map(
      (rol) =>
        (rol_encontrado = this.state.roles.filter(
          (id_rol) => id_rol.id === this.props.location.state.Rols
        ))
    );
                ...
                <form onSubmit={this.crearEmpleado} className="col-8">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      disabled
                      type="text"
                      defaultValue={this.props.location.state.Dni}
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      type="text"
                      defaultValue={this.props.location.state.SecondaryPhone}
                      className="form-control"
                    />
                  </div>
                  <div className="form-group">
              ...
              <form onSubmit={this.crearEmpleado} className="col-8">
                ...
                <div className="form-group">
                  ...
                  <select ref={this.rolRef} className="form-control">
                    <option
                      disabled
                      defaultValue={this.props.location.state.Rols}
                    >
                      Actual: {rol_encontrado[0].Name}
                    </option>

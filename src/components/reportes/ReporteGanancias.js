...
class ReporteGanancias extends Component {
  ...
  handleEvent = (event, picker) => {
    ...
    let end_date_finally = end_date.split('-')[0] + "-" + end_date.split('-')[1] + "-" + (parseInt(end_date.split('-')[2])+1)

    const gastos = axios.get(`https://roraso.herokuapp.com/Reports/Ganancias?min=${picker.startDate.format('YYYY-MM-DD')}&max=${end_date_finally}`,

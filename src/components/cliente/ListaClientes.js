...
let tHead = ["Nombre", "Apellido", "Email", "Telefono", "Acciones"];
...
class ListaClientes extends Component {
  ...
  render() {
    ...
    if (this.props.clientes == null || this.props.clientes == undefined)
      return (
        <div style={{ marginTop: "40px", marginBottom: "40px" }}>
          <DotLoader
            css={override}
    ...
    if (clientes.length === 0) {
      ...
      return (
        <SortableTbl
          tblData={clientes.sort(function (a, b) {
            return b.id - a.id;
          })}
          tHead={tHead}
          Permisos={this.props.usuario}
          customTd={[{ custd: ActionClienteComponent, keyItem: "Actions" }]}
          dKey={col}
          search={true}
          defaultCSS={true}

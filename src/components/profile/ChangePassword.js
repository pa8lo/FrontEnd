            ...
            <main>
              <Paper className={classes.paper}>
                <form className={classes.form}>
                  ...
                  <FormHelperText
                    error={this.state.passwordError}
                    style={{ display: this.state.passwordErrorDisplay }}
                  >
                  ...
                  <FormControl margin="normal" required fullWidth>
                    ...
                    />
                    <FormHelperText
                      error={!this.state.newPasswordErrorEmpty}
                      filled={false}
                      style={{
                        display: this.state.newPasswordErrorEmptyDisplay,
                      }}
                    >
                      Este campo es obligatorio
                    </FormHelperText>
                    <FormHelperText
                      error={!this.state.newPasswordErrorLenght}
                      filled={false}
                      style={{
                        display: this.state.newPasswordErrorLenghtDisplay,
                      }}
                    >
                      La contraseña debe tener un minimo de 6 numeros o letras
                    </FormHelperText>
                  </FormControl>
                  <FormControl margin="normal" required fullWidth>
                    <InputLabel htmlFor="password">
                    ...
                    <FormHelperText
                      ...
                      filled={false}
                      style={{
                        display: this.state.repeatPasswordErrorEmptyDisplay,
                      }}
                    >
                      Este campo es obligatorio
                    </FormHelperText>
                    <FormHelperText
                      ...
                      filled={false}
                      style={{
                        display: this.state.repeatPasswordErrorNotSameDisplay,
                      }}
                    >

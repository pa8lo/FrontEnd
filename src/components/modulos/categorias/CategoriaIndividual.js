...
class MyVerticallyCenteredModal extends Component {
  ...
  crearDireccion = (e) => {
    ...
    axios
      .post("https://roraso.herokuapp.com/User/AddAddress", data, {
        ...
        <Container style={{ marginTop: 10 }}>
          <Panel bsStyle="info">
            ...
            <Panel.Body xs={4}>
              ...
              <h2>Rol: {this.props.empleado.user.Rols}</h2>
            </Panel.Body>
...
export default connect(mapStateToProps, { eliminarEmpleado, mostrarEmpleado })(
  EmpleadoIndividual
);
